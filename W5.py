...
def mk_df(date_info, aud_usd_info, eur_aud_info):
    ...
    df
    """
    date_series = pd.Series(data=[value for key, value in date_info], index =[key for key, value in date_info])
    aud_usd_series = pd.Series(data=[value for key, value in aud_usd_info], index =[key for key, value in aud_usd_info])
    eur_aud_series = pd.Series(data=[value for key, value in eur_aud_info], index =[key for key, value in eur_aud_info])
